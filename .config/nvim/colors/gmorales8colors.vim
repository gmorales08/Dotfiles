...
highlight Function ctermfg=6 ctermbg=0 cterm=NONE
highlight Function guifg=#00ffff guibg=#000000 gui=NONE

highlight @lsp ctermfg=7     ctermbg=NONE    cterm=NONE
highlight @lsp guifg=#ffffff guibg=NONE      gui=NONE

highlight DiagnosticVirtualTextError ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticVirtualTextError guifg=#ff0000 guibg=NONE    gui=NONE
highlight DiagnosticVirtualTextWarn  ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticVirtualTextWarn  guifg=#ff0000 guibg=NONE    gui=NONE
highlight DiagnosticVirtualTextInfo  ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticVirtualTextInfo  guifg=#ff0000 guibg=NONE    gui=NONE
highlight DiagnosticVirtualTextHint  ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticVirtualTextHint  guifg=#ff0000 guibg=NONE    gui=NONE
highlight DiagnosticSignError        ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticSignError        guifg=#ff0000 guibg=NONE    gui=NONE
highlight DiagnosticSignWarn         ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticSignWarn         guifg=#ff0000 guibg=NONE    gui=NONE
highlight DiagnosticSignInfo         ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticSignInfo         guifg=#ff0000 guibg=NONE    gui=NONE
highlight DiagnosticSignHint         ctermfg=1     ctermbg=NONE  cterm=NONE
highlight DiagnosticSignHint         guifg=#ff0000 guibg=NONE    gui=NONE
